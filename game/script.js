...
submitBtn.addEventListener("click", function () { return __awaiter(_this, void 0, void 0, function () {
    var rawText, names, response, data, code, results, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                rawText = nameInput.value.trim();
                if (!rawText) {
            ...
            case 3:
                data = _a.sent();
                code = data.code, results = data.results;
                resultBox.innerHTML = "\n      <p><strong>\uAC8C\uC784 \uCF54\uB4DC:</strong> ".concat(code, "</p>\n      <p><strong>\uACB0\uACFC:</strong></p>\n      <ol>").concat(results.map(function (name) { return "<li>".concat(name, "</li>"); }).join(""), "</ol>\n    ");
                return [3 /*break*/, 5];
            case 4:
                err_1 = _a.sent();
